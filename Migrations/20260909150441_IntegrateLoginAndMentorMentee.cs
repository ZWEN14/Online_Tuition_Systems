...
{
    /// <inheritdoc />
    public partial class IntegrateLoginAndMentorMentee : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql(
                "UPDATE [Users] SET [RoleValue] = CASE [Role] " +
                "WHEN 'Tutor' THEN 1 WHEN 'Admin' THEN 2 ELSE 0 END");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Timeslots_Users_TutorId",
                        column: x => x.TutorId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StudentConfirmedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql(
                "UPDATE [Users] SET [RoleText] = CASE [Role] " +
                "WHEN 1 THEN 'Tutor' WHEN 2 THEN 'Admin' ELSE 'Student' END");
