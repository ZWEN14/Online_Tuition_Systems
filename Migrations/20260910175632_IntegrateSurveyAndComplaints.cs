...
{
    /// <inheritdoc />
    public partial class IntegrateSurveyAndComplaints : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AssignedTutorId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Complaints_Users_AssignedTutorId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ComplaintStatusHistories_Users_UpdatedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SurveyBranchRules", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SurveyBranchRules_QuestionOptions_QuestionOptionId",
                        column: x => x.QuestionOptionId,
                        principalTable: "QuestionOptions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SurveyBranchRules_SurveySections_DestinationSectionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Complaints_AssignedTutorId",
                table: "Complaints",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ComplaintStatusHistories_UpdatedByUserId",
                table: "ComplaintStatusHistories",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SurveyBranchRules_DestinationSectionId",
                table: "SurveyBranchRules",
                column: "DestinationSectionId");

            migrationBuilder.CreateIndex(
                name: "IX_SurveyBranchRules_QuestionOptionId",
                table: "SurveyBranchRules",
            ...
            migrationBuilder.Sql("""
                ...
                (N'Course Content', 1), (N'Tutor / Teaching', 1),
                (N'Technical Issue', 1), (N'Billing / Payment', 1), (N'Other', 1);
                """);
        }
